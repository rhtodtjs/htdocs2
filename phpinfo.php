...
<div id="wrap">
    ...
    <div id="container" align="center">
        ...
        <div class="info_msg">
            ...
            <p class="p_b10">ㆍ지금 화면이 계속 보인다면 <u class="c_00"><?= $_SERVER["SCRIPT_FILENAME"] ?></u> <font class="c_red">파일을
                    삭제</font>해 주시기 바랍니다.</p>
        </div>
        ...
        <table cellpadding="0" cellspacing="1" border="0" width="580" bgcolor="#d7d7d7" class="info_table">
            ...
            <tr>
                ...
                <td class="info_bg"><font class="c_00"><A HREF="http://127.0.0.1/?page=phpinfo" target="_blank">http://127.0.0.1/?page=phpinfo</A></font>
                </td>
            </tr>
            <tr>
                <td class="info_category">phpMyAdmin</td>
                <td class="info_bg"><font class="c_00"><a href="http://127.0.0.1/myadmin/" target="_blank">http://127.0.0.1/myadmin/</a></font>
                </td>
            </tr>
        </table>
