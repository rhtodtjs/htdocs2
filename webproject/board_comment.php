<?php
$sql = 'select * from board_comment where co_no=co_order and b_no=' . $bNo;
$result = $db->query($sql);
?>
<div id="commentView">
    <form action="board_comment_update.php" method="post">
        ...
        while($row = mysqli_fetch_array($result)) {
            ...
            <ul class="oneDepth">
                <li>
                    ...
                    <?php
                    $sql2 = 'select * from board_comment where co_no!=co_order and co_order=' . $row['co_no'];
